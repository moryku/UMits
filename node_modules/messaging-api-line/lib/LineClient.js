...
const debugRequest = (0, _debug2.default)('messaging-api-line');
...
class LineClient {
  ...
  options)
  {
    return this._send(type, target, [_Line2.default.createText(text, options || {})]);
  }
  ...
  previewUrlOrOptions)
  {
    ...
    _Line2.default.createImage(contentUrlOrImage, previewUrlOrOptions)]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createVideo(contentUrlOrVideo, previewUrlOrOptions || {})]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createAudio(contentUrlOrAudio, durationOrOptions || {})]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createSticker(packageIdOrSticker, stickerIdOrOptions || {})]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createFlex(altText, contents, options || {})]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createTemplate(altText, template, options || {})]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createButtonTemplate(
    altText,
    {
      thumbnailImageUrl,
      imageAspectRatio,
  ...
  {
    return this._send(type, target, [
    _Line2.default.createConfirmTemplate(
    altText,
    {
      text,
      actions },
  ...
  {})
  {let imageAspectRatio = _ref.imageAspectRatio,imageSize = _ref.imageSize,options = _objectWithoutProperties(_ref, ['imageAspectRatio', 'imageSize']);
    return this._send(type, target, [
    _Line2.default.createCarouselTemplate(altText, columns, _extends({
      imageAspectRatio,
      imageSize },
    options))]);
  ...
  {
    return this._send(type, target, [
    _Line2.default.createImageCarouselTemplate(altText, columns, options || {})]);
  ...
  getAllGroupMemberIds(groupId) {var _this = this;return _asyncToGenerator(function* () {
      ...
      do {
        ...
        var _ref2 = yield _this.getGroupMemberIds(
        groupId,
  ...
  getAllRoomMemberIds(roomId) {var _this2 = this;return _asyncToGenerator(function* () {
      ...
      do {
        // eslint-disable-next-line no-await-in-loop
        var _ref3 = yield _this2.getRoomMemberIds(
        roomId,
        continuationToken);const memberIds = _ref3.memberIds,next = _ref3.next;
